...
const Footer: React.FC = () => {
  const socialLinks = [
    {
      name: "LinkedIn",
      url: "https://www.linkedin.com/in/matheus-zufi/",
      icon: (
    ...
    {
      name: "GitHub",
      url: "https://github.com/matheuszufi",
      icon: <img src={GitHubIcon} alt="GitHub" className="footer-social-icon" />
    },
    {
      name: "WhatsApp",
      ...
      <div className="footer-container">
        ...
        <div className="footer-bottom">
          <p className="footer-copyright">
            © {currentYear} Matheus Zufi. Todos os direitos reservados.
          </p>
